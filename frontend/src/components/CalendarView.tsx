...
export default function CalendarView() {
    ...
    const ItemChip = ({ item, compact = false }: { item: DayItem; compact?: boolean }) => {
        ...
        return (
            <Link href={href} className="flex items-center gap-3 p-3 border-2 border-black bg-white dark:bg-slate-800 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-0.5 transition-all group">
        ...
        <div className="mt-16 pt-8 border-t-8 border-black">
                ...
                <div className="flex flex-col lg:flex-row gap-6">
                    <div className="flex-grow">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <h3 className="text-2xl font-permanent text-black dark:text-white uppercase">{MONTHS[month]} {year}</h3>
                            <button onClick={() => setCurrent(new Date(year, month + 1, 1))} className="p-2 border-4 border-black hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
            ...
            {view === 'list' && (
                <div className="space-y-8">
                    ...
                    <div>
                        <h3 className="text-xl font-permanent text-yellow-500 uppercase mb-3 flex items-center gap-2">
